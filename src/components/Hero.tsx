...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Gradient orbs */}
      <div className="absolute top-1/4 -left-32 w-96 h-96 dark:bg-accent-purple/20 bg-accent-purple/10 rounded-full blur-3xl animate-float-slow" />
      <div className="absolute bottom-1/4 -right-32 w-96 h-96 dark:bg-cyan-neon/15 bg-cyan-neon/10 rounded-full blur-3xl animate-float-medium" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] dark:bg-accent-pink/10 bg-accent-pink/5 rounded-full blur-3xl animate-glow-pulse" />

      {/* Floating shapes */}
      <div className="absolute top-20 left-[15%] w-20 h-20 border dark:border-cyan-neon/20 border-cyan-neon/30 rounded-xl rotate-12 animate-float-slow backdrop-blur-sm" />
      <div className="absolute top-40 right-[20%] w-16 h-16 border dark:border-accent-purple/20 border-accent-purple/30 rounded-full animate-float-medium backdrop-blur-sm" />
      <div className="absolute bottom-32 left-[25%] w-12 h-12 border dark:border-accent-pink/20 border-accent-pink/30 rounded-lg -rotate-12 animate-float-fast backdrop-blur-sm" />
      <div className="absolute bottom-48 right-[15%] w-24 h-24 border dark:border-cyan-neon/10 border-cyan-neon/20 rounded-2xl rotate-45 animate-float-slow backdrop-blur-sm" />
      <div className="absolute top-1/3 right-[10%] w-8 h-8 dark:bg-cyan-neon/10 bg-cyan-neon/15 rounded-full animate-float-fast" />
      <div className="absolute bottom-1/3 left-[10%] w-6 h-6 dark:bg-accent-purple/10 bg-accent-purple/15 rounded-full animate-float-medium" />

      {/* Grid overlay */}
      <div className="absolute inset-0 dark:bg-[linear-gradient(rgba(0,245,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(0,245,255,0.03)_1px,transparent_1px)] bg-[linear-gradient(rgba(0,100,200,0.04)_1px,transparent_1px),linear-gradient(90deg,rgba(0,100,200,0.04)_1px,transparent_1px)] bg-[size:60px_60px]" />
