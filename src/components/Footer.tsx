        ...
        <div className="flex flex-col sm:flex-row items-start justify-between gap-10 mb-10">
          ...
          <div className="flex flex-col items-start sm:items-end gap-6">
            ...
            <div className="flex flex-col gap-3">
              <a href="mailto:alex@example.com" className="flex items-center gap-3 dark:text-gray-300 text-gray-600 hover:text-cyan-500 transition-colors">
                ...
                <span className="text-sm hover:text-cyan-500">alex@example.com</span>
              </a>
              <a href="tel:+15551234567" className="flex items-center gap-3 dark:text-gray-300 text-gray-600 hover:text-cyan-500 transition-colors">
                ...
                <span className="text-sm hover:text-cyan-500">+1 (555) 123-4567</span>
              </a>
            </div>
