    ...
    <section id="contact" className="relative py-24 sm:py-32 overflow-hidden">
      ...
      <div ref={ref} className="relative z-10 max-w-5xl mx-auto px-6">
        <div className={`text-center mb-16 transition-all duration-700 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <p className="text-sm font-semibold tracking-widest uppercase text-cyan-neon mb-3">Get in Touch</p>
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          >
            ...
            <button
              ...
              className="group relative w-full px-8 py-4 rounded-xl font-semibold text-navy-900 dark:text-navy-900 bg-gradient-to-r from-cyan-neon to-accent-purple overflow-hidden transition-all duration-300 hover:scale-[1.02] disabled:opacity-70 disabled:cursor-not-allowed"
            >
              ...
              {/* Glow effect */}
              <div className="absolute -inset-1 bg-gradient-to-r from-cyan-neon to-accent-purple rounded-xl blur-lg opacity-30 group-hover:opacity-50 transition-opacity duration-500 -z-10" />
            </button>
          </form>
        </div>
      </div>
